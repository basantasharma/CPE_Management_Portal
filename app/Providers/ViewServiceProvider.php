...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::composer(['routersetting'], function ($view) {
            $view->with('routerSettingInfo', json_decode((new RouterSettingController())->getRouterSettingInfo($id = '00259E-EG8141A5-48575443F6E9A3A4'), true));  
        });
        View::composer(['routersetting','dashboard'], function ($view) {
